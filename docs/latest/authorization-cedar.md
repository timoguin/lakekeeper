---
title: "Authorization (Cedar)"
description: "Check the Authorization Configuration for configuration options."
source: "https://docs.lakekeeper.io/docs/latest/authorization-cedar/"
---
...
|-----------------------------------------------------------|--------------------------|-----|
| <code>LAKEKEEPER__CEDAR__<br>PROPERTY_PARSE_PREFIXES</code> | `["access_", "access-"]` | List of property key prefixes that trigger entity-reference parsing. Set to `[]` to disable parsing entirely. |
