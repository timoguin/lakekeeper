...
description: "An admission gate makes a coarse allow/deny decision about an already-authenticated request before it reaches any handler \u2014 distinct from the per-resource Authorizer. Use one to consult an external\u2026"
source: "https://docs.lakekeeper.io/docs/latest/admission/"
---
