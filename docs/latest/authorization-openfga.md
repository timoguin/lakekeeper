---
title: "Authorization (OpenFGA)"
description: "Lakekeeper can use OpenFGA to store and evaluate permissions. OpenFGA provides bi-directional inheritance, which is key for managing hierarchical namespaces in modern lakehouses. For query engines\u2026"
source: "https://docs.lakekeeper.io/docs/latest/authorization-openfga/"
---
