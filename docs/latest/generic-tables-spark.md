...
description: "This page shows how to read and write a Lance generic table from PySpark. The Lakekeeper client resolves the table location and vends short-lived storage credentials; Spark (and pylance) then\u2026"
source: "https://docs.lakekeeper.io/docs/latest/generic-tables-spark/"
---
