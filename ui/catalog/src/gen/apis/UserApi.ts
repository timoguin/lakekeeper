...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createUser(createUserRequest: CreateUserRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (createUserRequest === null || createUserRequest === undefined) {
            throw new RequiredError("UserApi", "createUser", "createUserRequest");
        }


        // Path Params
        const localVarPath = '/management/v1/user';
     ...
     * @param id 
     */
    public async deleteUser(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // Path Params
        const localVarPath = '/management/v1/user/{id}'
     ...
     */
    public async listUser(name?: string, pageToken?: string, pageSize?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async searchUser(searchUserRequest: SearchUserRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (searchUserRequest === null || searchUserRequest === undefined) {
            throw new RequiredError("UserApi", "searchUser", "searchUserRequest");
        }


        // Path Params
        const localVarPath = '/management/v1/search/user';
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(searchUserRequest, "SearchUserRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     */
    public async updateUser(id: string, updateUserRequest: UpdateUserRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateUserRequest === null || updateUserRequest === undefined) {
            throw new RequiredError("UserApi", "updateUser", "updateUserRequest");
        }
    ...
    public async whoami(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/management/v1/whoami';
...
export class UserApiResponseProcessor {
     ...
     */
     public async createUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<User> >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<User> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<User> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listUser
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<ListUsersResponse> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<ListUsersResponse> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<ListUsersResponse>", ""
            ) as Array<ListUsersResponse>;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to searchUser
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<SearchUserResponse> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<SearchUserResponse> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<SearchUserResponse>", ""
            ) as Array<SearchUserResponse>;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async whoamiWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<User> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<User> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
