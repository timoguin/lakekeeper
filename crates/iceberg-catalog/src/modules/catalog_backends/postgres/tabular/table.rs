use crate::modules::catalog_backends::postgres::{dbutils::DBErrorHandler as _, CatalogState};
...
use crate::modules::catalog_backends::postgres::tabular::{
...
{
    crate::modules::catalog_backends::postgres::tabular::tabular_ident_to_id(
        warehouse_id,
...
where
    E: 'e + sqlx::Executor<'c, Database = sqlx::Postgres>,
{
    let table_map = crate::modules::catalog_backends::postgres::tabular::tabular_idents_to_ids(
        warehouse_id,
        tables
            .into_iter()
...
pub(crate) async fn rename_table(
    ...
    crate::modules::catalog_backends::postgres::tabular::rename_tabular(
        warehouse_id,
...
pub(crate) mod tests {
    ...
    use crate::modules::catalog_backends::postgres::namespace::tests::initialize_namespace;
    use crate::modules::catalog_backends::postgres::warehouse::set_warehouse_status;
    ...
    use crate::modules::catalog_backends::postgres::tabular::mark_tabular_as_deleted;
