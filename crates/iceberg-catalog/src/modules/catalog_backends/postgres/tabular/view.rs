...
use crate::modules::catalog_backends::postgres::dbutils::DBErrorHandler as _;
use crate::{
...
pub(crate) mod tests {
    ...
    use crate::modules::catalog_backends::postgres::tabular::view::load_view;
    use crate::modules::catalog_backends::postgres::warehouse::test::initialize_warehouse;
    use crate::modules::catalog_backends::postgres::CatalogState;
  ...
  "properties": {
    ...
    async fn create_view(pool: sqlx::PgPool) {
        ...
        let namespace_id =
            crate::modules::catalog_backends::postgres::tabular::table::tests::get_namespace_id(
                state.clone(),
                warehouse_id,
                &namespace,
            )
