use crate::modules::catalog_backends::postgres::dbutils::DBErrorHandler;
use crate::modules::catalog_backends::postgres::tabular::TabularType as DbTabularType;
use crate::modules::catalog_backends::postgres::task_queues::{
    pick_task, queue_task, record_failure, record_success,
};
use crate::modules::catalog_backends::postgres::DeletionKind;
...
mod test {
    ...
    async fn test_queue_expiration_queue_task(pool: PgPool) {
        ...
        assert_eq!(
            task.deletion_kind,
            crate::modules::catalog_backends::postgres::DeletionKind::Default.into()
        );
