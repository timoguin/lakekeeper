...
pub(crate) async fn get_warehouse_by_name(
    warehouse_name: &str,
...
pub(crate) async fn set_warehouse_deletion_profile<
    'c,
    'e: 'c,
...
pub(crate) mod test {
    use super::*;
    use crate::modules::catalog_backends::postgres::{PostgresCatalog, PostgresTransaction};
    use crate::modules::object_stores::S3Flavor;
    use crate::modules::CatalogBackend as _;
    use crate::modules::{object_stores::S3Profile, Transaction as _};
