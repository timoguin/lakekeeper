...
use crate::modules::catalog_backends::postgres::role::search_role;
use crate::modules::catalog_backends::postgres::tabular::view::{
    create_view, drop_view, list_views, load_view, rename_view, view_ident_to_id,
};
use crate::modules::catalog_backends::postgres::tabular::{list_tabulars, mark_tabular_as_deleted};
use crate::modules::catalog_backends::postgres::user::{
    create_or_update_user, delete_user, list_users, search_user,
};
use crate::modules::TabularIdentOwned;
use crate::modules::{
    object_stores::StorageProfile, CatalogBackend, CreateNamespaceRequest, CreateNamespaceResponse,
...
impl CatalogBackend for super::PostgresCatalog {
    ...
    async fn load_view<'a>(
        ...
        include_deleted: bool,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ) -> Result<crate::modules::catalog_backends::postgres::tabular::view::ViewMetadataWithLocation>
    {
