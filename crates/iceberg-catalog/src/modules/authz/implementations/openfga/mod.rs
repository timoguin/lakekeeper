...
#[cfg(test)]
pub(crate) mod tests {
    use crate::modules::authz::implementations::openfga::{MockClient, OpenFGAAuthorizer};
    ...
    mod openfga {
        use super::super::*;
        use crate::modules::authz::implementations::openfga::client::new_authorizer;
        use crate::modules::RoleId;
        use http::StatusCode;
