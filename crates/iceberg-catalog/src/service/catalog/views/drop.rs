...
use crate::service::catalog::tables::validate_table_or_view_ident;
use uuid::Uuid;

pub(crate) async fn drop_view<C: CatalogBackend, A: Authorizer + Clone, S: SecretStore>(
...
mod test {
    ...
    use crate::service::catalog::views::drop::drop_view;
