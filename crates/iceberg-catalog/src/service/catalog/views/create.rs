...
use crate::service::catalog::io::write_metadata_file;
use crate::service::catalog::tables::{
    determine_tabular_location, maybe_body_to_json, require_active_warehouse,
    validate_table_or_view_ident,
};
use crate::service::catalog::views::validate_view_properties;
use crate::service::catalog::{maybe_get_secret, require_warehouse_id};
...
pub(crate) async fn create_view<C: CatalogBackend, A: Authorizer + Clone, S: SecretStore>(
...
pub(crate) mod test {
    ...
    use crate::modules::catalog_backends::postgres::secrets::SecretsState;
    ...
    pub(crate) async fn create_view(
        api_context: ApiContext<
            State<
                AllowAllAuthorizer,
                crate::modules::catalog_backends::postgres::PostgresCatalog,
                SecretsState,
            >,
        >,
    ...
    async fn test_create_view(pool: PgPool) {
        let (api_context, namespace, whi) =
            crate::service::catalog::views::test::setup(pool, None).await;
