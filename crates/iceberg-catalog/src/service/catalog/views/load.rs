...
use crate::service::catalog::require_warehouse_id;
use crate::service::catalog::tables::{require_active_warehouse, validate_table_or_view_ident};
use crate::service::catalog::views::parse_view_location;
use iceberg_ext::catalog::rest::LoadViewResult;

pub(crate) async fn load_view<C: CatalogBackend, A: Authorizer + Clone, S: SecretStore>(
...
pub(crate) mod test {
    ...
    use crate::modules::catalog_backends::postgres::PostgresCatalog;
    ...
    use crate::service::catalog::views::create::test::create_view;
    use crate::service::catalog::views::test::setup;
