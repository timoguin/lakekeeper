...
use crate::modules::{
    authz::Authorizer, secrets::SecretStore, CatalogBackend, GetWarehouseResponse, State,
...
use crate::service::catalog::views::{parse_view_location, validate_view_updates};
use http::StatusCode;
...
pub(crate) async fn commit_view<C: CatalogBackend, A: Authorizer + Clone, S: SecretStore>(
...
mod test {
    ...
    use crate::service::catalog::views::create::test::{create_view, create_view_request};
