...
use crate::service::catalog::tables::{maybe_body_to_json, validate_table_or_view_ident};
use http::StatusCode;
use iceberg_ext::catalog::rest::RenameTableRequest;
use uuid::Uuid;

pub(crate) async fn rename_view<C: CatalogBackend, A: Authorizer + Clone, S: SecretStore>(
...
mod test {
    ...
    use crate::service::catalog::views::load::test::load_view;
